    ...
    <section className="bg-white dark:bg-gray-800">
      ...
      <div className="bg-[#F1F1F1] -mt-10 dark:bg-gray-900">
        <div className="text-container max-w-6xl mx-auto pt-20">
          ...
          >
            If you ended up here you found an error on my side and I'm so sorry about it. If the error persists please <a href="/contacts" className="hover-underline-animation" style={{color : "#0A369D"}}> contact me </a>.
