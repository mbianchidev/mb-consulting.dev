        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            ...
            <div className="social-icons flex flex-row space-x-8">
              <a href={userData.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full hover:bg-blue-500 flex items-center justify-center cursor-pointer">
              ...
              <a href={userData.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full hover:bg-blue-500 flex items-center justify-center cursor-pointer" >
