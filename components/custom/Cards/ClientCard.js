...
export default function ClientCard ({ code, companyName, companyType, companySector, companyLogo, companyLogoX, companyLogoY, companyUrl, role, story, year }) {
  return (
    <div id={code} className="relative client-card border border-slate-200 dark:border-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-2xl bg-white dark:bg-slate-800 z-10 mx-4 transition-all duration-300 hover:-translate-y-1 group">
