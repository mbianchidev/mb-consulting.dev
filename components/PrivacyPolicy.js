      ...
      <div className="bg-[#F1F1F1] -mt-10 dark:bg-gray-900">
        <div className="text-container mx-auto pt-20" style={{marginLeft : "10px"}}>
          ...
          <div className={normalTextStyle}>
            ...
            <br></br>
            <br></br>
            We, {userData.name}, operate {userData.domain} (hereinafter referred to as <b>"Service"</b>).<br></br>
            This Privacy Policy governs your visit to my site, It explains how We collect, safeguard and disclose information that results from your use of this Service.<br></br>
            ...
            <b>DATA CONTROLLER</b> means a natural or legal person who (either alone or jointly or in common with other persons) determines the purposes for which and the manner in which any personal data are, or are to be, processed. For the purpose of this Privacy Policy, We am a Data Controller of your data.<br></br>
          ...
          <div className={normalTextStyle}>
            ...
            While using this Service, We may ask you to provide us with certain personally identifiable information that can be used to contact or identify you (<b>"Personal Data"</b>). <br></br>
            ...
            We strongly advise you to use a VPN service to protect your privacy and navigate possibly with privacy enforcing browsers and services such as <u><Link target="_blank" rel="noopener noreferrer" href="https://www.torproject.org">Tor</Link></u>.<br></br>

            <br></br>
            <h3 className={h3TextStyle}>Tracking Cookies Data</h3>
            <br></br>
            
            Visit my <u><Link target="_blank" rel="noopener noreferrer" href="/cookie-policy">Cookie Policy page</Link></u> to learn more about cookies and how We use them.<br></br>
            ...
            <ul>
              ...
              <li>to gather analysis or valuable information so that We can improve this Service;</li>
              ...
              <li>to provide you with news, special offers and general information about other goods, services and events which We offer that are similar to those that you have already purchased or enquired about (only if you have opted to receive such information);</li>
            ...
            (for example, if We am required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.<br></br>
            Usage Data will be retained only for internal analysis purposes.<br></br>
            Usage Data is generally retained for a shorter period, except when this data is used to strengthen the security or to improve the functionality of this Service, or We am legally obligated to retain this data for longer time periods.<br></br>
            ...
            We am going to disclose your Personal Data if required to do so by law only if We am presented with a valid request by a democratic country and if my legal department validates this request. In any case you will be informed.<br></br> 

            <br></br>
            <h3 className={h3TextStyle}>Other cases. We may disclose your information also:</h3>
            <br></br>
            <ul>
              ...
              <li>if We believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company.</li>
            </ul>
            <br></br>
            ...
            In case of data breaches or hacks, We will notify you as soon as possible while taking appropriate actions to protect your data and legally prosecute the entity responsible for the attack.<br></br>
          </div>
          ...
          <div className={normalTextStyle}>
            ...
            If you wish to be informed what Personal Data We hold about you and if you want it to be removed from my system, please contact us at: <Link href={mailTo}><u>privacy@mb-consulting.dev</u></Link>.<br></br>
            ...
            <br></br> 
            Please note that We will ask you to verify your identity before responding to such requests. <br></br>
          ...
          <div className={normalTextStyle}>
            ...
            <br></br> 
            We honor Do Not Track signals and do not track, create or read cookies when a Do Not Track browser mechanism is in place.<br></br> 
          ...
          <div className={normalTextStyle}>
            ...
            <br></br>
            <br></br>
            <b>What personal information We have about you.</b><br></br>
            ...
            <ul>
              ...
              <li>A list of categories of personal information that We may have sold, along with the category of any other company We sold it to. If We have not sold your personal information, We will inform you of that fact.</li>
              <li>A list of categories of personal information that We may have have disclosed for a business purpose, along with the category of any other company We shared it with.</li>
            </ul>
            <br></br>
            ...
            If you make this request, We will delete the personal information We hold about you as of the date of your request from my records and direct any service providers to do the same.<br></br>
            ...
            In no circumstances, We will discriminate against you for exercising your rights.<br></br>
          ...
          <br></br>
          <div className={normalTextStyle}>
            We may employ third party companies and individuals to facilitate this Service (<b>"Service Providers"</b>), provide Service on my behalf, perform Service-related services or assist us in analysing how this Service is used.<br></br>
          ...
          <div className={normalTextStyle}>
            ...
            We also encourage you to review the <u><Link target="_blank" rel="noopener noreferrer" href="https://support.google.com/analytics/answer/6004245">Google's policy for safeguarding your data</Link></u>.<br></br>
          </div>

          <h1 className={h1TextStyle} style={{textAlign : "center"}}>CI/CD tools</h1>
          <br></br>
          <div className={normalTextStyle}>
            We may use third-party Service Providers to automate some processes of this Service.<br></br>
          ...
          <br></br>
          <div className={normalTextStyle}>
            We don't use remarketing services to advertise on third party websites to you after you visited this Service.<br></br>

            <br></br>
            <h2 className={h2TextStyle}>Google Ads and Analytics</h2>  
            <br></br>
            We don't use Google Ads or any ads on this Service.<br></br>
          ...
          <div className={normalTextStyle}>
            ...
            If We become aware that Personal Data from Children has been collected, We take steps to remove that information.<br></br>
          </div>
          ...
          <div className={normalTextStyle}>
            ...
            If it's possible We will let you know via email and/or a prominent notice on this Service, prior to the change becoming effective and update "effective date" at the top of this Privacy Policy.<br></br>
          ...
          <br></br>
          <div className={normalTextStyle}>
            If you have any questions about this Cookie Policy, please contact us at <Link href={mailTo}><u>privacy@mb-consulting.dev</u></Link>.
          </div>
