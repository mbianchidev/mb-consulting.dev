const userData = {
  ...
  employers: [
    ...
    {
      companyName: "Uniteam @ Vodafone",
      companyType: "Corporate",
      companySector: "Internet Provider and Telecomunication Services",
  ...
  about: {
    title:
      "I have been working in the IT industry since 2017. I ❤️ DevOps culture, I am passionate about clouds 🌩️, I'm obsessed with IT security 🔐 and I'm eager to learn, develop and teach new stuff 🧑‍💻",
    description: [
      ...
      `A few things about me: I'm proud to be a remote worker 🏝️ and a Hybrid Digital Nomad™ ✈️🏡️ This means I will still be reliable even if we live in different timezones!`,
      `My goal is to bring value to your business by designing, managing and securing your cloud infrastructure.`,
      `Enabling your company to craft quality software as I'm recommending the best techs, tools and frameworks for your use-case, automating \& optimizing your processes (yes, cost optimization included 💸), implementing good practices and boosting your team(s) knowledge base.`,
