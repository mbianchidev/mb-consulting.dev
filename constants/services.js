  ...
  services: [
    ...
    },
    {
      ...
      description: [
        ...
        `I will ensure and coordinate the migration. The plan will be executed carefully, to avoid any downtime, disservice or data loss.`,
      ],
    ...
    },
    {
      ...
      description: [
        ...
        `- High resource usage, sub-optimal resource allocation and overprovisioning`,
        `- Bad infrastructure configuration (VMs, containers, k8s clusters, etc.)`,
        ...
        `This service is focused on Cloud Native workloads running on containers and Kubernetes.`,
        `Compliance with GDPR, PCI-DSS, ISO 27001, NIST, etc. compliance will be easier to achieve after this service.`,
    ...
    },
    {
      ...
      description: [
        ...
        `Is your product missing delivery deadlines and you don't know why? Let's figure out what is going on and turn around your situation.`,
        ...
        `Anything needed to keep your business running smoothly will be taken care of.`,
      ],
