...
const servicesData = {
    ...
    services: [
        ...
        },
        {
          ...
          description: [
              `The focus of this service is guiding your company in a full DevOps adoption to make you able to deliver your software product faster and with a much higher quality and in less time.`,
              `The adoption path is divided in 3 phases:`,
              `1. Assessment`,
              `2. Implementation`,
              `3. Support`,
              `The assessment phase is aimed at understanding your current situation and the needs of your company, in terms of both DevOps maturity and technical maturity`,
              `The DevOps Maturity Assessment is a questionnaire that will help me understand your current situation and the needs of your company. It will also help me understand the level of knowledge of your team and the real level of automation of your processes.`,
              `The Technical Assessment is a technical interview with the key people of your company to understand the current situation of your infrastructure and the needs of your company.`,
              `The implementation phase is aimed at implementing the DevOps culture in your company and it is divided in 2 activities:`,
              `- DevOps Culture Training Course`,
              `- DevOps Toolbox Choice`,
              `The Course is made for your employees, it is aimed at teaching them the DevOps culture and how it can help them improve their work. Raising awareness and training are the key points of this phase.`,
              `We will begin with a 1-week interactive course and workshop where your team will learn from scratch or improve their knowledge of DevOps culture and processes.`,
              `After the course and workshop, the team will be enabled to implement the DevOps culture in their daily work and will be able to start implementing the DevOps Toolchains, meanwhile I will be monitoring the progress and supporting the activities.`,
              `Implementing DevOps in your company, needs to be done in a step-by-step approach, so we will start with a pilot team and product and then we will add more effort as the DevOps need grows.`,
              `Our first focus will be on:`,
              `- Infrastructure automation`,
              `- Software automation`,
              `Keep in mind that the toolchain implementation requires a lot of interaction and feedbacks from the technical team as well as with the management to design a roadmap that fits your needs.`,
              `As we progress, we will be able to implement more and more automation and we will be able to focus on other areas such as:`,
              `- DevSecOps`,
              `- Monitoring/Logging`,
              `- Incident management`,
              `- Observability/Telemetry`,           
            ],
          callout: 'Are you ready to become a DevOps company?',
          CTA: 'Sign up!',
        ...
        },
        {
          ...
          description: [
              ...
              `At first glance, it may seem that these two areas are completely different, but in reality they are very closely related.`,
              `The reliability of your product is directly related to the security of your product, if your product is not reliable, it will not be secure and vice versa.`,
              `The review will be divided in 2 phases:`,
              `First step being an assessment phase, where I will perform a security review of your product and I will identify the security issues and vulnerabilities as well as reliability issues.`,
              `The second step will be the implementation phase, where I will point out the security and reliability fixes and improvements that need to be implemented and I will help you implement them.`,
              ...
              `Same with reliability issues :`,
              `- Process failures`,
              `- High resource usage and memory leaks`,
              `- Wrong configuration of the infrastructure (VMs, containers, clusters, etc.)`,
              ...
              `I will also be able to help you with your Incident Management processes, improving the way your team is handling incidents and reducing the time to recovery. Individuation, Analysis, Migitation, Resolution, Communication and Improvement will be their mantra.`,
              `Provided with production-ready alerting and monitoring system they will be notified as soon as something goes wrong and they will be able to take action immediately, before it becomes a bigger issue.`,
              `There will be a lot of post-mortems, but they will be able to learn from their mistakes, document them and improve. DevSecOps and Site Reliability processes will improve the way your team is developing and deploying software, reducing the time to market and at the same time increasing the security of your product`,
        ...
        },
        {
          ...
          description: [
              ...
              `There is no need of micro-management, your team can already manage itself if you trust them, they may just needs a little help to get started and I'm here to help.`,
              ...
              `Your customers? They will be happier too, because they will be able to use your product without any issues.`,
              `I'll guide you and your team through a complete restyling of the software development lifecycle helping your developers to focus on new features and refactoring instead of fixing bugs and dealing with technical debt.`,
              `They will be enabled to build cutting edge digital products while applying good practices and upskilling themselves.`,
              `How will I do that?`,
              ...
              `Then I will help you to define a new software architecture and a roadmap to get there.`,
              ...
              `I will be able to guide your team in using the following technologies:`,
              ...
              `- Frontend: React, Tailwind, Angular`,
              `Me and your team will set a coding standard where code review will be a must and we will start to refactor the codebase.`,
              `Testing and documentation will be a priority, they will start to write unit tests and we will improve the documentation of the codebase so your new hires will be able to onboard faster.`,
              ...
              `Code quality will be scrutinized, we will use tools such as SonarQube and CodeClimate to make sure that your code is always clean and well documented.`,
              `Code will be well versioned and backed up, we will use Git and a good branching strategy to make sure that your code is always manageable.`,
          ],
          callout: 'Ready to turn your software lifecycle?',
