    ...
    services: [
        ...
        },
        {
          ...
          description: [
              ...
              `- DevOps Culture Traoining`,
              `- DevOps Toolchain`,
              `The DevOps Culture Training is made for the people of your company, it is aimed at teaching them the DevOps culture and how it can help them improve their work. Raising awareness and training are the key points of this phase.`,
              ...
              `After the course and workshop, the team will be enabled to implement the DevOps culture in their daily work and will be able to start implementing the DevOps Toolchain, meanwhile I will be monitoring the progress and coordinating the activities.`,
              `Implementing the DevOps toolchain in your company, needs to be done in a step-by-step approach, so we will start with a pilot team and product and then we will add more effort as the DevOps need grows.`,
              `Our first focuses will be on:`,
