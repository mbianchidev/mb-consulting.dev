  ...
  about: {
    ...
    story: {
      ...
      description: [
        ...
        `In 2023 I took the next step and I've been the CTO of a startup, KubeLab, where I enjoyed the challenge of building a new company culture, services and products from scratch and of course taking care of my team.`,
        `In 2024 I'll move away from Europe hopefully starting a new adventure in the software industry.`,
    ...
    goals: {
      ...
      description: [
        ...
        `In time I built strong bonds with employers, clients and colleagues. I always believed in trust as the foundation of each and every of these relationships.`,
        ...
        `Staying always updated about techs, understanding numbers and metrics, spreading good practices, boosting knowledge bases and above all: creating something with a positive impact on people and the planet.`,
      ],
    },
    techs: {
      shortTitle: "Tech Stack & Lightsabers",
      description: [
        `I'm a hands-on engineering manager, I love to try new languages, frameworks and cloud native technologies.`,
        `There's no such thing as "one size fits all", that's why I'm costantly looking for solutions and tools to fit different real-world requirements.`,
